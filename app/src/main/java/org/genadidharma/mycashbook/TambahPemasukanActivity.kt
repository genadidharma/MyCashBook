...
class TambahPemasukanActivity : AppCompatActivity() {
    private lateinit var binding: ActivityTambahPemasukanBinding
    private lateinit var db: MyCashBookDatabase

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityTambahPemasukanBinding.inflate(layoutInflater)
    ...
    private fun insert(date: String, money: String, description: String) {
        val cash = Cash(date, money, description, true)
